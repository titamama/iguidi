...
<h1 class="auteur">Gestion du bibliothèque</h1>
<p class="text-center" style="width:60%;margin:0 auto;border-radius:50px;font-size: 16px;font-weight: 500; color:rgba(192, 57, 43,1.0);font-family:'Raleway';padding:20px;border:1px solid #fff; background: rgba(255,255,255,0.9);">
 <span style="font-size: 20px;font-weight:700 "></span> </p><br><br>
<br>
<body>
	<div id="divdiv">
	<h2 id="recherche">Rechercher un document par auteur</h2>
	<form action="auteur_resultat.jsp" class="text-center">
		 <div class="col-lg-6">
		    <div class="input-group">
		      <input type="text" class="form-control" name="auteur" placeholder="Entrer le auteur ....">
